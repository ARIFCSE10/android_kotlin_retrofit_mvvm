...
import com.beliefit.tmq.mybookshop.activity.WishListActivity
import com.beliefit.tmq.mybookshop.model.BookEntity
import kotlinx.android.synthetic.main.book_list_row_home.view.*


class WishListRVAdapter : RecyclerView.Adapter<WishListRVAdapter.ViewHolder> {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        var view: View = LayoutInflater.from(context).inflate(R.layout.wish_list_row, parent, false)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        (context as WishListActivity).loadImageFromNetworkOrCache(holder, position, books?.get(position)?.preview)
